...
const char *kBridgeVersion = "26.21.0.2";
...
id gScrollXAxis = nil;
id gScrollYAxis = nil;
void (^gKeyChangedHandler)(id keyboardInput, id key, unsigned short keyCode,
                           BOOL pressed) = nil;
void (^gMouseMovedHandler)(id mouseInput, float deltaX, float deltaY) = nil;
void (^gMousePressedHandlers[3])(id buttonInput, float value,
                                 BOOL pressed) = {nil, nil, nil};
void (^gMouseValueHandlers[3])(id buttonInput, float value,
                               BOOL pressed) = {nil, nil, nil};
void (^gMouseTouchedHandlers[3])(id buttonInput, float value, BOOL pressed,
                                 BOOL touched) = {nil, nil, nil};
...
CGAssociateMouseAndMouseCursorPositionFn
    gCGAssociateMouseAndMouseCursorPosition = NULL;
...
id gBridgeHUDKeystrokesButton = nil;
...
bool gBridgeHUDKeystrokesEnabled = true;
...
double gBridgeHUDKeystrokesX = 1300.0;
double gBridgeHUDKeystrokesY = 600.0;
double gBridgeHUDKeystrokesSize = 50.0;
double gBridgeHUDKeystrokesAlpha = 1.0;
...
bool RespondsTo(id obj, SEL sel) {
  return obj != nil && ((BOOL(*)(id, SEL, SEL))objc_msgSend)(
                           obj, @selector(respondsToSelector:), sel);
}
...
bool IsTargetController(id self) {
  const char *className =
      self == nil ? NULL : class_getName(object_getClass(self));
